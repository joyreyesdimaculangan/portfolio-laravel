...
<form method="POST" action="{{ route('password.store') }}" class="space-y-6">
    ...
    <div>
        ...
        <div class="mt-1 relative">
            ...
            <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username"
                   class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:border-[#774C0C] focus:ring focus:ring-[#774C0C]/20 focus:ring-opacity-50" readonly />
        </div>
        @error('email')
    ...
    <div class="mt-4">
        ...
        <div class="mt-1 relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"></div>
            <input id="password" type="password" name="password" placeholder="Create a new password" required autocomplete="new-password"
    ...
    <div class="mt-4">
        ...
        <div class="mt-1 relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"></div>
            <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm your new password" required autocomplete="new-password"
                   class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:border-[#774C0C] focus:ring focus:ring-[#774C0C]/20 focus:ring-opacity-50" />
        </div>
